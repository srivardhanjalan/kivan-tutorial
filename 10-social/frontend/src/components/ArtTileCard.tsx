...
/**
 * An art tile with a caption: the one shape the wishlist, wish, and product
 * cards share. Each supplies its own wash, placeholder, and (for the two
 * priced ones) a cost subtitle; the wish card adds its fulfilled dim and check
 * badge via `dimmed` and `children`. Pressable when given an onPress, a plain
 * display tile without one (a wish viewed on another user's wishlist). The
 * tile/caption/subtitle composition lives here so those cards can't drift apart.
 */
